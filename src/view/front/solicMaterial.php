    ...
    <form action="../../controller/SolicitacaoMateriaisController.php" method="post" id="formSolicMateriais">
        ...
        <div class="containerBTN">
            <div class="botaoAcao">
                ...
                <button type="submit" id="btnInsertAtt">
...
<script type="text/javascript" src="../../../scripts/js/eng/solicMaterial.js"></script>
<script type="text/javascript" src="../../../scripts/js/class/Material.class.js"></script>
