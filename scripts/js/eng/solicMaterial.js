...
$(function() {
    ...
    function pesquisaMaterial() {
        ...
        if (pesquisa != '') {
            ...
            $.get('../../repository/eng/buscarMaterial.php', dados, function(retorno) {
...
$(function() {
    ...
    function pesquisaCentroCusto() {
        ...
        if (pesquisa != '') {
            ...
            $.get('../../repository/eng/buscarCCusto.php', dados, function(retorno) {
 ...
 * Valida Campos
 */
document.getElementById("formSolicMateriais").addEventListener("submit", function(event){
    let msg = '';
    ...
    if (document.getElementById('codigoMaterial').value == '') {
        msg += 'Informe o Material\n';
    }

    if (document.getElementById('qtdeMaterial').value == '') {
        msg += 'Informe a Qtde de Material\n';
    }

    if (document.getElementById('valorUnit').value == '') {
        msg += 'Informe o Valor unitário\n';
    }

    if (document.getElementById('codigoCCusto').value == '') {
    ...
    if (document.getElementById('mesAprov').value == '') {
