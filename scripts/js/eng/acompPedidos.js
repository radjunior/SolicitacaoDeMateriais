$(document).ready(function() {
    ...
    $.get('../../repository/eng/popularAcomp.php', param_1, function(mes) {
    ...
    $.get('../../repository/eng/popularAcomp.php', param_2, function(obj) {
    ...
    $.get('../../repository/eng/popularAcomp.php', param_3, function(stt) {
        console.log(stt);
        /*
         * Gráfico de status
         */
